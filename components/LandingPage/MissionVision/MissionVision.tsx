...
const MissionVision = () => {
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center gap-10 justify-center bg-black text-white pt-10 bg-[url(/landing/primaryBackground.png)] bg-cover bg-center border-2">
      {/* Background Image */}
      ...
      <div className="relative w-full h-[80vh] bg-[url(/landing/MissionVisionLayout.png)] bg-cover ">
        <div className="grid grid-cols-2 gap-8 w-full justify-center items-center h-full">
          {/* Mission Block */}
