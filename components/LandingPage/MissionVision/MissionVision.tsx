        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-8 w-full justify-around items-end xl:justify-center xl:items-center h-auto lg:h-[100vh]">
          ...
          >
            ...
            <p className="text-md md:text-2xl lg:text-3xl w-full max-w-3xl text-justify text-black tracking-widest">
              ...
              INVESTMENT PLATFORM FUELED BY EXPERT-DRIVEN ONLINE CRYPTO TRADING.
              ELEVATE IS COMMITTED TO LEVERAGING THE DYNAMIC WORLD OF
              CRYPTOCURRENCY TO DELIVER CONSISTENT AND GUARANTEED RETURNS WHILE
              FOSTERING FINANCIAL LITERACY, TRANSPARENCY, AND LONG TERM
          ...
          >
            ...
            <p className="text-md md:text-2xl lg:text-3xl w-full max-w-3xl text-justify text-black tracking-widest">
              TO BECOME A GLOBALLY RECOGNIZED LEADER IN CRYPTOCURRENCY-BASED
              INVESTMENTS DELIVERING CONSISTENT SUCCESS THROUGH CUTTING-EDGE
              TRADING STRATEGIES. ELEVATE ENVISIONS A FUTURE WHERE CRYPTO
              TRADING DRIVES FINANCIAL EMPOWERMENT, ENABLING EVERYONE TO ACHIEVE
              FINANCIAL INDEPENDENCE AND CREATE LASTING WEALTH.
            </p>
          </motion.div>
        </div>
      </motion.div>
