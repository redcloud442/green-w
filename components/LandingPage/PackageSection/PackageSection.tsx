...
const PackageSection = () => {
  ...
  return (
    <section className="relative min-h-screen h-full w-full flex flex-col  font-ethnocentric bg-black text-white bg-[url('/landing/primaryBackground.png')] bg-cover bg-center py-20 px-10">
