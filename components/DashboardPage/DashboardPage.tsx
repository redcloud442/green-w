...
const DashboardPage = ({
  ...
  return (
    <div className="relative min-h-screen mx-auto space-y-4 py-2 px-2 sm:px-0 mt-0 sm:mt-20 sm:mb-20 overflow-x-hidden">
      ...
      <div className="flex flex-row  sm:fixed w-full sm:min-w-fit sm:max-w-lg justify-between px-0 py-4 sm:px-2 sm:py-4 items-center top-2 bg-transparent sm:bg-cardColor sm:rounded-tr-lg sm:rounded-br-lg z-50 ">
        {/* Profile Section */}
